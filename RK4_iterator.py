...
def RK4_iterator(
    ...
    F_mat = model.get_x_matrix(
        ...
        I_roll_inst_f = I_roll_inst_f, I_roll_inst_r = I_roll_inst_r, I_pitch_inst = I_pitch_inst, I_roll_arm_inst_f = I_roll_arm_inst_f, I_roll_arm_inst_r = I_roll_arm_inst_r, I_pitch_arm_inst_f = I_pitch_arm_inst_f, I_pitch_arm_inst_r = I_pitch_arm_inst_r,  # Inertias, radii of rotation
        tw_f = self.tw_f, tw_r = self.tw_r, wheel_base_f = self.wheel_base * (1 - self.m_f), wheel_base_r = self.wheel_base * self.m_f, rc_height_f = self.rc_height_f, rc_height_r = self.rc_height_r, pc_height = self.pc_height_ic2cp, cm_height = self.cm_height, tire_diam_f = self.tire_diam_f, tire_diam_r = self.tire_diam_r,  # Vehicle geometries
